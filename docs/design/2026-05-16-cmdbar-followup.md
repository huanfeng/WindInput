<!-- Created: 2026-05-16 -->
<!-- Supersedes (partial): docs/design/2026-05-12-command-bar-design.md §3.4 命名 / §3.7 marker / §3.8 权重 -->

# 命令直通车 follow-up 设计 (2026-05-16)

> 本文是对 [2026-05-12-command-bar-design.md](./2026-05-12-command-bar-design.md) 的修订增量。
...
- 原设计：[2026-05-12-command-bar-design.md](./2026-05-12-command-bar-design.md)
