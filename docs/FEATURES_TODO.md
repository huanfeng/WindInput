...
#### 18. 自定义短语 ✅ 已完成
- [x] 支持自定义缩写（短语管理）
- [x] 设置界面中的短语编辑（code→text，权重配置）

#### 19. 模糊音 ✅ 已完成
- [x] z/zh, c/ch, s/sh
- [x] n/l, r/l
- [x] an/ang, en/eng, in/ing
- [x] 可选配置（11组模糊对，设置界面支持）
...
### 下一步计划
1. **用户词库自动学习** - 记录用户选词频次，自动调整候选排序
2. **候选词排序增强** - 按输入次数排序、单字优先、用户词优先选项
3. **反查功能 UI** - 候选窗口显示编码提示（框架已实现，缺 UI 渲染）
4. **双拼引擎** - 支持自然码/小鹤等双拼方案
5. **混合输入模式** - 拼音+五笔混合输入
