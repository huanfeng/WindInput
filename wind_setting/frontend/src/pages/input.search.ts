...
export const entries: SearchEntry[] = [
  ...
  { id: "s2t.enabled", tab, tabLabel, card: "简入繁出",
    title: "启用简入繁出", hint: "候选与上屏均输出繁体（基于 OpenCC 词典）",
    anchor: "s2t.enabled", keywords: ["简繁", "繁体", "OpenCC"] },
  { id: "s2t.variant", tab, tabLabel, card: "简入繁出",
  ...
  { id: "input.quick_input.trigger_keys", tab, tabLabel, card: "快捷输入",
    title: "触发键", hint: "空码时按触发键进入快捷输入模式，支持数字转大小写、金额、计算器、日期等",
    anchor: "input.quick_input.trigger_keys" },
  ...
  { id: "startup.default_chinese_mode", tab, tabLabel, card: "默认状态",
    title: "初始语言模式", hint: "每次激活输入法时的默认语言",
    options: ["中文", "英文"], anchor: "startup.default_chinese_mode" },
  { id: "startup.default_full_width", tab, tabLabel, card: "默认状态",
    title: "初始字符宽度", hint: "每次激活输入法时的默认字符宽度",
    options: ["半角", "全角"], anchor: "startup.default_full_width" },
  { id: "startup.default_chinese_punct", tab, tabLabel, card: "默认状态",
    title: "初始标点模式", hint: "每次激活输入法时的默认标点类型",
    options: ["中文标点", "英文标点"], anchor: "startup.default_chinese_punct" },
];
