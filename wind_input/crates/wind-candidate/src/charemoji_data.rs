...
//!
//! 数据源: Unicode `emoji-data.txt`（UTS #51）版本 **17.0**，属性 `Emoji`。
...
pub const UNICODE_EMOJI_VERSION: &str = "17.0";

/// `Emoji=Yes` 的码位，合并成升序、互不相邻的闭区间。共 1438 个码位、151 段。
///
...
pub const EMOJI_FIRST: u32 = 0x0023;
pub const EMOJI_LAST: u32 = 0x1FAF8;
pub const EMOJI_BMP_LAST: u32 = 0x3299;
pub const EMOJI_SUPP_FIRST: u32 = 0x1F004;
